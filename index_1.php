...
<!-- begin Convert Experiments code--><script type="text/javascript">/*rvidheader#1.5.0*/var REED_host = (("https:" == document.location.protocol) ? "https://s"+"3.ama"+"zonaw"+"s.com/statics"+".reedge.com" : "http://statics"+".reedge.com");var REED_s = 'REED_1000740_10001355';var REED_f;if((typeof(jQuery) != "undefined")) REED_f="REED_main_no_jquery.js";else REED_f="REED_main.js" ;document.write(unescape("%3Cscript src='" + REED_host + "/js/"+REED_f+"' type='text/javascript'%3E%3C/script%3E"));</script><!-- end Convert Experiments code -->
...
$(document).ready(function(){
	...
	//Try to redirect
	window.location.href="index_t.php?backurl="+window.location.href;
